        ...
        <div className="menus">
            <div className="menus__top">
                ...
                <div className="menus__top--right">
                    <Avatar src={user?.photoURL ? user.photoURL : "https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460__480.png"} />
                    <span>
                        {/* <h4>{user?.email}</h4> */}
                        <h4>{user?.email ? user?.email : 'parth.rathod12@gmail.com'}</h4>
                        <h5>Rs. 95825.00</h5>
                    </span>
                    <ExpandMoreIcon
